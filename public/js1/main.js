$(document).ready(function () {
    ...
    if (typeof window.route_mass_crud_entries_verify != 'undefined') {
        $('.datatable').siblings('.actions').html('<a href="' + window.route_mass_crud_entries_verify + '" class="btn btn-xs btn-success js-delete-selected" onclick="return confirm(\'Are you sure\');" style="margin-top:0.755em;margin-left: 20px;">Verify selected</a>');
    }
