...
if (! function_exists('display_path')) {
    /**
     * Generate an asset path for the application.
     *
     * @param  string  $path
     ...
     * @return string
     */
    function display_path($path, $secure = null)
    {
        $path = '/vendor/twbs/bootstrap/'.$path;
        return app('url')->asset($path, $secure);
    }
}
...
if (! function_exists('script_path')) {
     ...
     * @return string
     */
    function script_path($path, $secure = null)
    {
        $path = '/node_modules/jquery/dist/'.$path;
        return app('url')->asset($path, $secure);
    }
}
